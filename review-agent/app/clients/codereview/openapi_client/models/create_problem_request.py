...
class CreateProblemRequest(BaseModel):
    ...
    testcases: Optional[List[TestcaseRequest]] = None
    __properties: ClassVar[List[str]] = ["description", "assignmentId", "problemConstraint", "testcases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testcases": [TestcaseRequest.from_dict(_item) for _item in obj["testcases"]] if obj.get("testcases") is not None else None
        })
        return _obj
