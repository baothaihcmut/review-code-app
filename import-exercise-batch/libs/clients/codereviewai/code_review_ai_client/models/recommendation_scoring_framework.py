...
class RecommendationScoringFramework(BaseModel):
    ...
    readiness_level: StrictStr
    explanation: StrictStr
    __properties: ClassVar[List[str]] = ["risk_level", "readiness_level", "explanation"]
    ...
    def readiness_level_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['emerging', 'developing', 'ready']):
            raise ValueError("must be one of enum values ('emerging', 'developing', 'ready')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "readiness_level": obj.get("readiness_level"),
