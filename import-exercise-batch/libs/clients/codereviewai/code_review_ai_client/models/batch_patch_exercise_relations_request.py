...
class BatchPatchExerciseRelationsRequest(BaseModel):
    ...
    """ # noqa: E501
    exercises: Optional[List[BatchPatchExerciseRelationsItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exercises": [BatchPatchExerciseRelationsItem.from_dict(_item) for _item in obj["exercises"]] if obj.get("exercises") is not None else None
        })
        return _obj
