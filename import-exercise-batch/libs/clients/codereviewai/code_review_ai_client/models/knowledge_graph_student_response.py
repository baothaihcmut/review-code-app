...
class KnowledgeGraphStudentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["student_id", "student_profile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of student_profile
        if self.student_profile:
            _dict['student_profile'] = self.student_profile.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "student_profile": StudentProfileScoring.from_dict(obj["student_profile"]) if obj.get("student_profile") is not None else None
        })
        return _obj
