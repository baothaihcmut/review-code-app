...
class TopicDetailResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "assignments", "documents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignments": [AssignmentResponse.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
