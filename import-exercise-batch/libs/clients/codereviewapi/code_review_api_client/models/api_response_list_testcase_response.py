...
class ApiResponseListTestcaseResponse(BaseModel):
    """
    ApiResponseListTestcaseResponse
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[List[TestcaseResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [TestcaseResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
