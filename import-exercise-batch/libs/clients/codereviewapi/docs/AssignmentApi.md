# code_review_api_client.AssignmentApi
...
with code_review_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = code_review_api_client.AssignmentApi(api_client)
    create_assignment_request = code_review_api_client.CreateAssignmentRequest() # CreateAssignmentRequest | 
