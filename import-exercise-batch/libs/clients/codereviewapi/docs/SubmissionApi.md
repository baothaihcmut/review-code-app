# code_review_api_client.SubmissionApi
...
with code_review_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = code_review_api_client.SubmissionApi(api_client)
...
with code_review_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = code_review_api_client.SubmissionApi(api_client)
    submit_code_request = code_review_api_client.SubmitCodeRequest() # SubmitCodeRequest | 
