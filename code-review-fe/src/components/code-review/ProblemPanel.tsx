...
Implement function \`void process(const char str[], char outstr[])\` which eliminates redundant space characters so that there are no consecutive space characters and there is no space character at the beginning/end of string.\n
• **Input**: Char array contains the string  
